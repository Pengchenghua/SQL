...
coalesce(case when (business_division_code='11' and (cost_30day+receipt_amt+material_take_amt+coalesce(b.contain_transfer_entry_value,0)) <=0 and period_inv_amt_30day>0) then 9999 
		        ...
		        end,0)	as days_turnover_30_transfer from csx_tmp.ads_wms_r_d_goods_turnover a 
left join
...
a.total_qty,
 ...
 from csx_tmp.temp_02  a 
  ...
  select * from csx_tmp.temp_00 where classify_middle_name !='酒' and goods_id='1350631';
  
  select * from csx_tmp.p_contain_transfer_trunc where goods_id='1350631' and sdt='20220428';
