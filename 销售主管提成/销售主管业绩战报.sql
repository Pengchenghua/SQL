...
left join 
	(select customer_no,customer_name,work_no,sales_name,third_supervisor_work_no,first_supervisor_work_no,third_supervisor_name
...
as 
select
	region_code,region_name,province_code,province_name,city_group_code,city_group_name,channel,channel_name,work_no,sales_name,
...
group by region_code,region_name,province_code,province_name,city_group_code,city_group_name,channel,channel_name,work_no,sales_name,
...
left join 
		...
		(region_name_1,province_code,channel_name,manager_name),
		(region_name_1,province_code,channel_name,manager_name,customer_attribute_name))
		)b 
