...
from
	...
	select
		...
		reservoir_area_code
	from
		csx_ods.wms_accounting_stock_detail_ods  where sdt='20190915') a
join (
	select
		product_code,
		location_code,
	...
	where
		to_date(posting_time)in('2019-09-01') and sdt='20190915'
	group by
		product_code,
		location_code,
		shipper_code,
...
join (
	...
	from
		csx_ods.wms_accounting_stock_detail_ods
	where
		to_date(posting_time) >='2019-09-01'and to_date(posting_time)<='2019-09-15' and sdt='20190915'
	group by
		product_code,
		location_code,
		shipper_code,
