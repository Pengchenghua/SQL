...
where sdt>='20200101' 
  ...
  --  and receive_location_code in ('W0G1','W0J8')
...
left join 
(select concat('S',),vendor_name from csx_dw.dws_basic_w_a_csx_supplier_m where sdt='current') d on a.supplier_code=d.vendor_id
;
    
select * from csx_tmp.ads_sale_r_d_zone_cust_attribute_fr where months='202009' and province_code ='24';
select * from b2b.ord_orderflow_t where sdt>='20200101' and sdt<='20200131' and shop_id_in ='9975';
refresh csx_tmp.ads_sale_r_d_zone_cust_attribute_fr;

select * from csx_dw.dws_basic_w_a_csx_supplier_m  where sdt='current' and vendor_id ='SW0K6';
select * from csx_ods.source_wms_r_d_bills_config where sdt='20200917';