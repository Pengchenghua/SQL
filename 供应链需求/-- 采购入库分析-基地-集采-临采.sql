...
select 
  ...
  from  csx_analyse_tmp.csx_analyse_tmp_entry_goods a
  left join 
  (select order_code,create_by from  csx_dwd.csx_dwd_scm_order_header_di where sdt>='20230101' group by order_code,create_by) b on a.purchase_order_code=b.order_code
  where receive_sdt>='20230501'
 -- and order_business_type_name='是'