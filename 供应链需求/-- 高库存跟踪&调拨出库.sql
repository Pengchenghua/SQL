...
CREATE temporary table csx_tmp.temp_turn_aa as 
SELECT d.sales_province_code province_code,
       d.sales_province_name province_name,
       a.dc_code,
       a.dc_name,
       a.goods_id,
       a.goods_name,
       ...
       max_shpp_date,
       datediff(current_date(),from_unixtime(unix_timestamp(max_shpp_date,'yyyyMMdd'),'yyyy-MM-dd')) as no_sale_day,
       b.entry_days,
       b.entry_qty,
       b.entry_sdt,
       b.period_inv_qty,
       ...
       b.material_take_qty,
       b.material_take_amt,
       b.contain_transfer_entry_qty,
   
       b.contain_transfer_entry_value,
       b.contain_transfer_entry_sdt,
           b.contain_transfer_entry_days
       
from csx_tmp.temp_stock_a a 
LEFT JOIN 
csx_tmp.p_contain_transfer_trunc b on a.dc_code=b.dc_code and a.goods_id=b.goods_id 
LEFT JOIN 
...
(select 
    ...
    case when purchase_org ='P620' or shop_id ='W0J8'  then '100'
    else sales_province_code end sales_province_code,
    case when  purchase_org ='P620' or shop_id ='W0J8' then '全国-平台' 
...
from csx_dw.dws_basic_w_a_csx_shop_m
 where sdt='current'    
    ...
    select * from csx_tmp.temp_turn_aa;