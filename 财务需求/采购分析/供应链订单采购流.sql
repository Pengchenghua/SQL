...
create table csx_analyse_tmp.csx_analyse_tmp_entry_00 as
select   order_no,
    receive_no,
    batch_code,
    dc_code,
...
create  table csx_analyse_tmp.csx_analyse_tmp_order_table as 
select 
...
(select  order_code,
    super_class,
    source_type,
    source_location_code as settle_dc_code,                     -- 结算DC
...
from csx_dim.csx_dim_shop
 where sdt='current'    ) s on a.source_location_code=s.shop_code
...
create  table csx_analyse_tmp.csx_analyse_tmp_order_table_01 as 
select 
    performance_province_code,
    performance_province_name,
    performance_city_code,
