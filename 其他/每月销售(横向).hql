SELECT
  ...
  case
    ...
    else coalesce(province_name, prov_name)
  end province_name,
  case
    when qstype in(
      '大宗',
...
FROM (
    SELECT
      ...
      sum(
        case
          WHEN sdt >= '201901' THEN sale
        END
      ) s_2019,
      sum(
        case
          WHEN sdt = '201912' THEN sale
        END
      ) s_201912,
      sum(
        case
          WHEN sdt = '201911' THEN sale
        END
      ) s_201911,
      sum(
        case
          WHEN sdt = '201910' THEN sale
        END
      ) s_201910,
      sum(
        case
          WHEN sdt = '201909' THEN sale
        END
      ) s_201909,
      sum(
        case
          WHEN sdt = '201908' THEN sale
        END
      ) s_201908,
      sum(
        case
          WHEN sdt = '201907' THEN sale
        END
      ) s_201907,
      sum(
        case
          WHEN sdt = '201906' THEN sale
        END
      ) s_201906,
      sum(
        case
          WHEN sdt = '201905' THEN sale
        END
      ) s_201905,
      sum(
        case
          WHEN sdt = '201904' THEN sale
        END
      ) s_201904,
      sum(
        case
          WHEN sdt = '201903' THEN sale
        END
      ) s_201903,
      sum(
        case
          WHEN sdt = '201902' THEN sale
        END
      ) s_201902,
      sum(
        case
      ...
      sum(
        case
          WHEN sdt >= '201910'
          and sdt <= '201912' THEN sale
        END
      ) Q4_sale,
      sum(
        case
          WHEN sdt >= '201907'
          and sdt <= '201909' THEN sale
        END
      ) Q3_sale,
      sum(
        case
          WHEN sdt >= '201904'
          and sdt <= '201906' THEN sale
        END
      ) Q2_sale,
      sum(
        case
          WHEN sdt >= '201901'
          and sdt <= '201903' THEN sale
        END
      ) Q1_sale,
      sum(
        case
          ...
          AND sdt <= substr(
            regexp_replace(
              to_date(
                add_months(date_sub(current_timestamp(), 1), -12)
              ),
              '-',
              ''
            ),
      ...
      sum(
        case
          WHEN sdt >= '201901' THEN profit
        END
      ) p_2019,
      sum(
        case
          WHEN sdt = '201912' THEN profit
        END
      ) p_201912,
      sum(
        case
          WHEN sdt = '201911' THEN profit
        END
      ) p_201911,
      sum(
        case
          WHEN sdt = '201910' THEN profit
        END
      ) p_201910,
      sum(
        case
          WHEN sdt = '201909' THEN profit
        END
      ) p_201909,
      sum(
        case
          WHEN sdt = '201908' THEN profit
        END
      ) p_201908,
      sum(
        case
          WHEN sdt = '201907' THEN profit
        END
      ) p_201907,
      sum(
        case
          WHEN sdt = '201906' THEN profit
        END
      ) p_201906,
      sum(
        case
          WHEN sdt = '201905' THEN profit
        END
      ) p_201905,
      sum(
        case
          WHEN sdt = '201904' THEN profit
        END
      ) p_201904,
      sum(
        case
          WHEN sdt = '201903' THEN profit
        END
      ) p_201903,
      sum(
        case
          WHEN sdt = '201902' THEN profit
        END
      ) p_201902,
      sum(
        case
      ...
      sum(
        case
          WHEN sdt >= '201910'
          and sdt <= '201912' THEN profit
        END
      ) q4_fit,
      sum(
        case
          WHEN sdt >= '201907'
          and sdt <= '201909' THEN profit
        END
      ) q3_fit,
      sum(
        case
          WHEN sdt >= '201904'
          and sdt <= '201906' THEN profit
        END
      ) q2_fit,
      sum(
        case
          WHEN sdt >= '201901'
          and sdt <= '201903' THEN profit
        END
      ) q1_fit
    FROM (
        SELECT
        ...
        where
          ...
          AND sdt >= regexp_replace(
            to_date(trunc(date_sub(current_timestamp(), 1), 'YY')),
            '-',
            ''
          )
        GROUP BY
        ...
        where
          ...
          AND sdt >= regexp_replace(
            to_date(
              trunc(
                date_sub(current_timestamp(), 366),
                'YY'
              )
            ),
            '-',
...
left join (
    select
      ...
      sales_name as district_manager_name,
      province_code
