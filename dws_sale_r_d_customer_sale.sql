CREATE TABLE `csx_dw.dws_sale_r_d_customer_sale`
	(
		...
		`item_channel_code` string COMMENT 'item渠道编号-1.大客户 2.商超 4.大宗 5.供应链(食百) 6.供应链(食百) 8.其他'   ,
		...
		`attribute_code` int COMMENT '客户属性 1:日配客户 2:福利客户 3:贸易客户 4:战略客户 5:合伙人客户'                  ,
		`attribute` string COMMENT '客户属性 1:日配客户 2:福利客户 3:贸易客户 4:战略客户 5:合伙人客户'                    ,
		...
		`sign_date` string COMMENT '客户签约日期'                                                      ,
		`sign_week` string COMMENT '客户签约周'                                                       ,
		`sign_month` string COMMENT '客户签约月'                                                      ,
		...
		`customer_group` string COMMENT '客户组'                                                               ,
