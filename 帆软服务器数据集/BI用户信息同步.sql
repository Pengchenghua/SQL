 ...
 employee_name,
    ...
    mobile  phone_no ,    
    case when  (emp_sub_name LIKE '永辉彩食鲜%'or emp_sub_name like '彩食鲜共享%' or emp_sub_name like '%永辉企业购招投标2300店%' or emp_sub_name like '彩食鲜-富平%') then SUBSTRING_INDEX(SUBSTRING_INDEX(org_name,'_',2),'_',-1)
...
from     csx_basic_data.erp_employee ee 
	...
	and ee.card_type ='0'
	and (ee.company_name LIKE '%彩食鲜%' or ee.emp_sub_name  like '%企业购%')
	)erp 
	left join (
