...
JOIN
  (SELECT dist_code,
   ...
   WHERE sdt='current'
     ...
     AND a.location_code IN ('W0A2','W0A3', 'W0A5', 'W0A6', 'W0A7', 'W0A8',  'W0F4', 'W0K1', 'W0R9', 'W0K6', 'W0L3','W0N0', 'W0N1',  'W0P8', 'W0Q2', 'W0Q9')) b ON a.shop_code=b.location_code
left join 
(SELECT product_code,
       shop_code,
...
and dc_code in ('W0A2','W0A3', 'W0A5', 'W0A6', 'W0A7', 'W0A8',  'W0F4', 'W0K1','W0R9', 'W0K6', 'W0L3','W0N0', 'W0N1', 'W0P8', 'W0Q2', 'W0Q9')
...
where
  ...
  and  root_category_code in ('10','11','12','13')
  and a.product_name!=''
  and shop_code in ('W0A2','W0A3', 'W0A5', 'W0A6', 'W0A7', 'W0A8',  'W0F4', 'W0K1', 'W0R9', 'W0K6', 'W0L3','W0N0', 'W0N1',  'W0P5', 'W0P8', 'W0Q2', 'W0Q9','W0W7')
...
WHERE a.root_category_code in ('10','11','12','13')
 and a.shop_code in ('W0A2','W0A3', 'W0A5', 'W0A6', 'W0A7', 'W0A8',  'W0F4', 'W0K1', 'W0R9', 'W0K6', 'W0L3','W0N0', 'W0N1',  'W0P5', 'W0P8', 'W0Q2', 'W0Q9','W0W7')
...
JOIN
  (SELECT a.province_code,
   ...
   WHERE sdt='current'
     AND location_type_code='1'
     AND a.location_code IN ('W0A2','W0A3', 'W0A5', 'W0A6', 'W0A7', 'W0A8',  'W0F4', 'W0K1', 'W0R9', 'W0K6', 'W0L3','W0N0', 'W0N1',  'W0P5', 'W0P8', 'W0Q2', 'W0Q9','W0W7')
...
where sdt>=${hiveconf:sdate}and sdt<=${hiveconf:edate}
    and division_code in ('12','13','11','10')
    and dc_code in('W0A2','W0A3', 'W0A5', 'W0A6', 'W0A7', 'W0A8',  'W0F4', 'W0K1', 'W0R9', 'W0K6', 'W0L3','W0N0', 'W0N1',  'W0P5', 'W0P8', 'W0Q2', 'W0Q9','W0W7')
