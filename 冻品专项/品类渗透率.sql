...
CREATE  TABLE csx_tmp.ads_sale_r_d_frozen_fr(
  ...
  daily_cust_number bigint comment '日配业务成交客户数（总）', 
  last_daily_cust_number bigint comment '环期日配业务成交客户(总)', 
  sales_cust_number bigint comment '成交客户数(B端)', 
  last_sales_cust_number bigint comment '环期成交客户数(B端)', 
