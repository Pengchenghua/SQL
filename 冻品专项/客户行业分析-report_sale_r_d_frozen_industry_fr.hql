...
((channel_name,
    ...
    classify_large_name,
    a.classify_middle_code,
    a.classify_middle_name),  --7711	 省区中类汇总
    (channel_name,
    region_code,
    region_name,
    province_code,
    ...
    classify_large_name,
    a.classify_middle_code,
    a.classify_middle_name),  --8167 大区行业中类统计
    (channel_name,
    region_code,
    region_name,
    classify_large_code,
    ...
    classify_large_name,
    a.classify_middle_code,
    a.classify_middle_name),  --7687 大区中类汇总
     (channel_name,
    region_code,
    region_name,
    first_category_code,
    first_category_name,
    second_category_code,
    second_category_name),  --	487 大区行业汇总
    (channel_name,
    region_code,
    region_name),  --7 大区汇总
    (channel_name,
    ...
    classify_large_name,
    a.classify_middle_code,
    a.classify_middle_name),  --7681 全国中类汇总
     (channel_name,
    first_category_code,
    first_category_name,
    second_category_code,
    second_category_name),  --	481 全国行业汇总
    ()   --0 
)
;
...
select
    case when a.grouping__id = '0' then '0'
     ...
     when a.grouping__id='7861' then '2'
     when a.grouping__id='3237' then '3'
     when a.grouping__id = '32757' then '3' 
     when a.grouping__id = '8161' then '4'
